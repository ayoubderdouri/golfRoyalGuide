    ...
    })()(
        {
                    ...
                    (r.prototype = {
                        select: function (t, e) {
                            ...
                            if (
                                ...
                                (i.resultId = t.id),
                                (n !== this.lastSentIndex || i.queryString !== this.lastSentInput) && -1 != n && ((this.lastSentIndex = n), (this.lastSentInput = i.queryString), i.queryString))
                            )
                                return this.push(i);
                        },
                        start: function (t) {
                        ...
                        getRequestOptions: function (t) {
                            return Array.isArray(t) || (t = [t]), { method: "POST", host: this.origin, path: this.endpoint + "?access_token=" + this.access_token, headers: { "Content-Type": "application/json" }, body: JSON.stringify(t) };
                        },
                    ...
                    (r.prototype = {
                        ...
                        onAdd: function (t) {
                            if (
                                ...
                                this.setLanguage(),
                                this.options.localGeocoderOnly || (this.geocoderService = h(l({ accessToken: this.options.accessToken, origin: this.options.origin }))),
                            ...
                            var c = (this._typeahead = new o(this._inputEl, [], { filter: !1, minLength: this.options.minLength, limit: this.options.limit }));
                                ...
                                this.geolocation
                                    ...
                                    .then(
                                        function (t) {
                                            ...
                                            var e = { geometry: { type: "Point", coordinates: [t.coords.longitude, t.coords.latitude] } };
                                            ...
                                            var n = { limit: 1, language: [this.options.language], query: e.geometry.coordinates, types: ["address"] };
                                            if (this.options.localGeocoderOnly) {
                                                var i = e.geometry.coordinates[0] + "," + e.geometry.coordinates[1];
                                                this._setInputValue(i), this._eventEmitter.emit("result", { result: e });
                                            } else
                                                    ...
                                                    .then(
                                                        function (t) {
                                                            ...
                                                            if (n) {
                                                                ...
                                                                this._setInputValue(i), (n.user_coordinates = e.geometry.coordinates), this._eventEmitter.emit("result", { result: n });
                                                            } else this._eventEmitter.emit("result", { result: { user_coordinates: e.geometry.coordinates } });
                                                        }.bind(this)
                                                    );
                                        }.bind(this)
                                    )
                        ...
                        _fly: function (t) {
                            ...
                            if (t.properties && c[t.properties.short_code]) (e = a({}, this.options.flyTo)), this._map && this._map.fitBounds(c[t.properties.short_code].bbox, e);
                                ...
                                (e = a({}, i, this.options.flyTo)),
                                    t.center ? (e.center = t.center) : t.geometry && t.geometry.type && "Point" === t.geometry.type && t.geometry.coordinates && (e.center = t.geometry.coordinates),
                        ...
                        _setupConfig: function (t, e) {
                            ...
                            switch (t) {
                                case y.REVERSE:
                                    ...
                                    break;
                                case y.FORWARD:
                                    /^[ ]*(-?\d+\.?\d*)[, ]+(-?\d+\.?\d*)*[ ]*$/.test(e) && (e = e.replace(/,/g, " ")), (o = a(o, { query: e }));
                            }
                            return o;
                        },
                        _geocode: function (t) {
                            (this.inputString = t), this._showLoadingIcon(), this._eventEmitter.emit("loading", { query: t });
                            var e,
                                ...
                                e
                                    ...
                                    .then(
                                        function (e) {
                                            ...
                                            var n = {};
                                            return (
                                                e ? "200" == e.statusCode && ((n = e.body), (n.request = e.request), (n.headers = e.headers)) : (n = { type: "FeatureCollection", features: [] }),
                                                (n.config = i),
                                                ...
                                                this.options.externalGeocoder
                                                    ? ((o = this.options.externalGeocoder(t, n.features) || Promise.resolve([])),
                                                      o.then(
                                                          function (t) {
                                    ...
                                    .then(
                                        function (t) {
                                            ...
                                            this.options.filter && t.features.length && (t.features = t.features.filter(this.options.filter)),
                                                t.features.length
                                                    ? (this._showClearButton(), this._hideGeolocateButton(), this._showAttribution(), this._eventEmitter.emit("results", t), this._typeahead.update(t.features))
                                                    : (this._hideClearButton(), this._hideAttribution(), (this._typeahead.selected = null), this._renderNoResults(), this._eventEmitter.emit("results", t));
                                        }.bind(this)
                                    )
                                    .catch(
                                        function (t) {
                                            this._hideLoadingIcon(),
                                                ...
                                                (r.length && this.options.localGeocoder) || (o.length && this.options.externalGeocoder)
                                                    ? (this._showClearButton(), this._hideGeolocateButton(), this._typeahead.update(r))
                                                    : (this._hideClearButton(), (this._typeahead.selected = null), this._renderError()),
                        ...
                        setOrigin: function (t) {
                            return (this.options.origin = t), (this.geocoderService = h(l({ accessToken: this.options.accessToken, origin: this.options.origin }))), this;
                        },
                        getOrigin: function () {
                            return this.options.origin;
                        },
                        setAccessToken: function (t) {
                            return (this.options.accessToken = t), (this.geocoderService = h(l({ accessToken: this.options.accessToken, origin: this.options.origin }))), this;
                        },
                            ...
                            if (this._map) {
                                ...
                                return (
                                    ...
                                    t.center
                                        ...
                                        : t.geometry && t.geometry.type && "Point" === t.geometry.type && t.geometry.coordinates && this.mapMarker.setLngLat(t.geometry.coordinates).addTo(this._map),
                                    this
                                );
                            }
                        },
            ...
            6: [
                function (t, e, n) {
                    ...
                    e.exports = { transformFeatureToGeolocationText: i, getAddressInfo: r };
                },
                {},
            ],
            7: [
                function (t, e, n) {
                    ...
                    function i(t) {
                        ...
                        return function (i) {
                            ...
                            for (var s = 0; s < i.length; s++) if ((o = r(n(s), i[s]))) return [s].concat(o);
                        };
                    }
                    function r(t, e) {
                    ...
                    function o(t, e) {
                        var n = t.length,
                            i = t[n - 1],
                            r = t.slice(0, n - 1);
                        return 0 === r.length && (r = [d]), (e = f(e, { path: r })), "function" == typeof i ? i(e) : c(e, a(i));
                    }
                    function s(t) {
            ...
            10: [
                function (t, e, n) {
                    ...
                    function r(t, e) {
                        return new c(t, { body: e.response, headers: p(e.getAllResponseHeaders()), statusCode: e.status });
                    }
                    function o(t) {
                        var e = t.total,
                            n = t.loaded;
                            ...
                            r &&
                                ...
                                (e.onload = function () {
                                    if ((delete f[t.id], e.status < 200 || e.status >= 400)) {
                                        var r = new l({ request: t, body: e.response, statusCode: e.status });
                                        return void i(r);
                                    }
                                    n(e);
                                });
                ...
                { "../classes/mapi-error": 12, "../classes/mapi-response": 14, "../constants": 15, "../helpers/parse-headers": 16 },
            ],
            11: [
                function (t, e, n) {
                    "use strict";
                ...
                { "../constants": 15, "./mapi-request": 13, "@mapbox/parse-mapbox-token": 25 },
            ],
            12: [
                function (t, e, n) {
                    "use strict";
            ...
            13: [
                ...
                { "../constants": 15, "../helpers/url-utils": 18, "@mapbox/parse-mapbox-token": 25, eventemitter3: 27, xtend: 39 },
            ],
            14: [
                function (t, e, n) {
                    "use strict";
            ...
            19: [
                function (t, e, n) {
                    ...
                    (u.forwardGeocode = function (t) {
                        ...
                        var e = s(i({ country: t.countries }, o(t, ["proximity", "types", "autocomplete", "bbox", "limit", "language", "routing", "fuzzyMatch", "worldview"])));
                        return this.client.createRequest({ method: "GET", path: "/geocoding/v5/:mode/:query.json", params: o(t, ["mode", "query"]), query: e });
                    }),
                        (u.reverseGeocode = function (t) {
                            r.assertShape({
                                ...
                                (t.mode = t.mode || "mapbox.places");
                            var e = s(i({ country: t.countries }, o(t, ["country", "types", "bbox", "limit", "language", "reverseMode", "routing", "worldview"])));
                            return this.client.createRequest({ method: "GET", path: "/geocoding/v5/:mode/:query.json", params: o(t, ["mode", "query"]), query: e });
                        }),
                        (e.exports = a(u));
                },
                { "./service-helpers/create-service-factory": 20, "./service-helpers/pick": 22, "./service-helpers/stringify-booleans": 23, "./service-helpers/validator": 24, xtend: 39 },
            ],
            20: [
                function (t, e, n) {
                    "use strict";
                            ...
                            !(function (o) {
                                ...
                                var l = function (t) {
                                    ...
                                    d = function (t) {
                                        ...
                                        for (var e, n, i, r, o = t.length % 3, s = "", a = -1, u = t.length - o; ++a < u; )
                                            (e = t.charCodeAt(a) << 16),
                                                (n = t.charCodeAt(++a) << 8),
                                                (i = t.charCodeAt(++a)),
                                                (r = e + n + i),
                                                (s += h.charAt((r >> 18) & 63) + h.charAt((r >> 12) & 63) + h.charAt((r >> 6) & 63) + h.charAt(63 & r));
                                        return (
                                            2 == o
                                                ? ((e = t.charCodeAt(a) << 8), (n = t.charCodeAt(++a)), (r = e + n), (s += h.charAt(r >> 10) + h.charAt((r >> 4) & 63) + h.charAt((r << 2) & 63) + "="))
                                                : 1 == o && ((r = t.charCodeAt(a)), (s += h.charAt(r >> 2) + h.charAt((r << 4) & 63) + "==")),
                                            s
                                        );
                                    },
            ...
            27: [
                function (t, e, n) {
                    ...
                    var u = Object.prototype.hasOwnProperty,
                        c = "~";
                    Object.create && ((i.prototype = Object.create(null)), new i().__proto__ || (c = !1)),
                        ...
                        (a.prototype.emit = function (t, e, n, i, r, o) {
                            ...
                            if (l.fn) {
                                ...
                                var p,
                                    f = l.length;
                                for (u = 0; u < f; u++)
                                    switch ((l[u].once && this.removeListener(t, l[u].fn, void 0, !0), h)) {
                                        case 1:
            ...
            28: [
                function (t, e, n) {
                    ...
                    function s(t, e, n) {
                        if (e) t.call(n);
                        else for (var i = t.length, r = y(t, i), o = 0; o < i; ++o) r[o].call(n);
                    }
                    function a(t, e, n, i) {
                        if (e) t.call(n, i);
                        else for (var r = t.length, o = y(t, r), s = 0; s < r; ++s) o[s].call(n, i);
                    }
                    function u(t, e, n, i, r) {
                        if (e) t.call(n, i, r);
                        else for (var o = t.length, s = y(t, o), a = 0; a < o; ++a) s[a].call(n, i, r);
                    }
                    function c(t, e, n, i, r, o) {
                        if (e) t.call(n, i, r, o);
                        else for (var s = t.length, a = y(t, s), u = 0; u < s; ++u) a[u].call(n, i, r, o);
                    }
                    function l(t, e, n, i) {
                        if (e) t.apply(n, i);
                        else for (var r = t.length, o = y(t, r), s = 0; s < r; ++s) o[s].apply(n, i);
                    }
                    function h(t, e, n, r) {
                        var s, a, u;
                        ...
                        if (((a = t._events), a ? (a.newListener && (t.emit("newListener", e, n.listener ? n.listener : n), (a = t._events)), (u = a[e])) : ((a = t._events = x(null)), (t._eventsCount = 0)), u)) {
                            if (("function" == typeof u ? (u = a[e] = r ? [n, u] : [u, n]) : r ? u.unshift(n) : u.push(n), !u.warned && (s = o(t)) && s > 0 && u.length > s)) {
                                ...
                                (c.name = "MaxListenersExceededWarning"),
                                    ...
                                    (c.type = e),
                                    (c.count = u.length),
                                    "object" === ("undefined" == typeof console ? "undefined" : i(console)) && console.warn && console.warn("%s: %s", c.name, c.message);
                            }
                    ...
                    !(function () {
                        ...
                        void 0 !== n ? (e.exports = i) : (t.fuzzy = i),
                            ...
                            (i.match = function (t, e, n) {
                                ...
                                return r === t.length ? ((a = h === t ? 1 / 0 : a), { rendered: o.join(""), score: a }) : null;
                            }),
                                        ...
                                        : ((n = n || {}),
                                          e
                                              .reduce(function (e, r, o, s) {
                                                  ...
                                                  var u = i.match(t, a, n);
                                                  return null != u && (e[e.length] = { string: u.rendered, score: u.score, index: o, original: r }), e;
                                              }, [])
                                              .sort(function (t, e) {
                            ...
                            var o = function (t) {
                                ...
                                s = function (t, e, n) {
                                    var i = (2 << (Math.log(t.length - 1) / Math.LN2)) - 1,
                                        r = -~((1.6 * i * e) / t.length);
                                    return function () {
                                        for (var o = ""; ; ) for (var s = n(r), a = r; a--; ) if (((o += t[s[a] & i] || ""), o.length === e)) return o;
                                    };
                                },
                                a = function (t, e) {
                                    return s(t, e, o);
            ...
            35: [
                function (t, e, n) {
                    ...
                    !(function (t, n, i) {
                        ...
                        function n(e) {
                            return (e = t(e)), { language: e[1] || o, extlang: e[2] || o, script: e[3] || o, region: e[4] || o };
                        }
                        function i(t, e, n) {
